$(document).ready(function() {
  ...
  $(".comment-form input[title], .comment-form textarea, .forms textarea").each(
    function() {
      if ($(this).val() === "") {
...
jQuery(document).ready(function() {
  ...
  var shrinked_header_height = 64,
    ...
    navItems = jQuery('.navbar ul a[href^="#"]').not(
      '.navbar ul a[href="#"], .navbar ul a.fancybox-inline'
    );
  ...
  jQuery(window).scroll(function() {
    ...
    navItems.each(function() {
      ...
      if (jQuery(thisHref).length) {
        ...
        if (scrollPosition >= thisPosition) {
          ...
          jQuery(".navbar ul a[href=" + thisHref + "]")
            .parent("li")
            .addClass("current");
        }
      }
    ...
    bottomPage =
      parseInt(jQuery(document).height(), 10) -
      parseInt(jQuery(window).height(), 10);
...
(function($, window, document, undefined) {
  ...
  if (filtersContainer.hasClass("cbp-l-filters-dropdown")) {
    ...
    filtersCallback = function(me) {
      wrap
        .find(".cbp-filter-item-custom")
        .removeClass("cbp-filter-item-custom-active");
  ...
  gridContainer.cubeportfolio(
    "showCounter",
    filtersContainer.find(".cbp-filter-item-custom"),
    function() {
...
var instagramFeed = new Instafeed({
  ...
  template:
    '<div class="item"><figure class="frame"><img src="{{image}}" /><a href="{{link}}" class="ins-link" target="_blank"><i class="icon-link"></i></a></figure></div>',
  after: function() {
    $(".swiper-container.instagram").each(function() {
      ...
      $swipers.siblings(".arrow-left").click(function() {
        $swipers
          .data("swiper")
          .swipeTo($swipers.data("swiper").activeIndex - 1);
        return false;
      });
